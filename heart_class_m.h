 ...
 */
    enum type CheckAVDissociation(std::vector<int> rPeaks, int currR);
 ...
 */
    void Classify_Type(std::shared_ptr<std::vector<int>> rPeaks, std::vector<int> QRSend, int fs);
 ...
 * @param[in]       fs - sampling frequency
 */
     void Classify_Cluster(std::shared_ptr<std::vector<int>> rPeaks, std::vector<int> QRSend, int fs);
 ...
 * @param[in]       fs - sampling frequency
 */
    heart_class(std::shared_ptr<std::vector<int>> rPeaks, std::vector<int> QRSend, int fs);
